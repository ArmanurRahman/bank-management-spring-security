...
update customer set pwd = '$2a$12$9cw057VgIZTTkR4RouYll.VPZ1k030qCULmrez0zxUYMtulcWnf8W' where customer_id = 1;

INSERT INTO `customer` (`name`,`email`,`mobile_number`, `pwd`, `role`,`create_dt`)
 VALUES ('Admin','arman@gmail.com','9876548337', '$2a$12$9cw057VgIZTTkR4RouYll.VPZ1k030qCULmrez0zxUYMtulcWnf8W', 'admin',CURDATE());
